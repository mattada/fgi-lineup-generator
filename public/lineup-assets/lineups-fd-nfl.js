...
lineupGenerator.sliders.config = {
  ...
  data: {
    ...
    change_slate_text: window.slate_global === 'FD NFL Main' ? 'FanDuel NFL SAT ONLY' : 'FanDuel NFL SUN ONLY',
    current_slate_text: window.slate_global === 'FD NFL Main' ? 'FanDuel NFL SUN ONLY' : 'FanDuel NFL SAT ONLY',
    totalSpotsUsed: 0,
