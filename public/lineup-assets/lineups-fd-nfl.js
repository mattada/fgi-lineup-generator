...
lineupGenerator.sliders.config = {
  ...
  data: {
    ...
    change_slate_text: window.slate_global === 'FD NFL Main' ? 'FanDuel NFL SAT ONLY' : 'FanDuel NFL Main',
    current_slate_text: window.slate_global === 'FD NFL Main' ? 'FanDuel NFL Main' : 'FanDuel NFL SAT ONLY',
    totalSpotsUsed: 0,
