...
lineupGenerator.sliders.config = {
  ...
  data: {
    ...
    change_slate_text: window.slate_global === 'DK NFL Main' ? 'DraftKings NFL SUN ONLY' : 'DraftKings NFL Main',
    current_slate_text: window.slate_global === 'DK NFL Main' ? 'DraftKings NFL Main' : 'DraftKings NFL SUN ONLY',
    totalSpotsUsed: 0,
