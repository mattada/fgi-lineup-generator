...
lineupGenerator.sliders.config = {
  ...
  data: {
    ...
    change_slate_text: window.slate_global === 'DK NFL Main' ? 'DraftKings NFL SAT ONLY' : 'DraftKings NFL Main',
    current_slate_text: window.slate_global === 'DK NFL Main' ? 'DraftKings NFL Main' : 'DraftKings NFL SAT ONLY',
    totalSpotsUsed: 0,
