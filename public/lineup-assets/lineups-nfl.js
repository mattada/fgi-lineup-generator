...
lineupGenerator.sliders.config = {
  ...
  data: {
    ...
    change_slate_text: window.slate_global === 'DK NFL Main' ? 'DraftKings NFL THANKSGIVING' : 'DraftKings NFL Main',
    current_slate_text: window.slate_global === 'DK NFL Main' ? 'DraftKings NFL Main' : 'DraftKings NFL THANKSGIVING',
    totalSpotsUsed: 0,
