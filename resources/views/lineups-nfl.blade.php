    ...
    @if(true)
      ...
      <div style="margin: 10px 0;" class="alert alert-info" role="alert">
        <p class="initial-hide">
          ...
          <p>Also consider: <a style="text-decoration: underline;" href="/lineup-generator-fd-nfl">FanDuel NFL THANKSGIVING slate</a> or <a style="text-decoration: underline;" href="/lineup-generator-fd-nfl/main">FanDuel NFL Main slate</a></p>
        </p>
      </div>
      <header>
        <div class="filters">
