      ...
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="players-wrapper">
          <div class="row" style="margin-top: -8px; margin-bottom: 2px;">
            <div class="col-md-8 col-sm-8 col-xs-8" v-if="players[0].tee_3.length > 0">
              <b>Course:</b>
            </div>
          ...
          <div class="row" style="margin-top: -8px; margin-bottom: 2px;" v-if="players[0].tee_3.length > 0">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <small>
                <span class="label label-success">SC</span> = Torrey Pines GC (South)
              </small>
              <small style="margin-left: 10px;">
                <span class="label label-info">NC</span> = Torrey Pines GC (North)
              </small>
            </div>
          </div>
          <table class="players">
            ...
            <tbody>
              <tr v-for="player in players">
                <td class="fgi-player-name" style="width: 55%;"><span v-if="player.tee_3.length > 0" v-html="player.tee_3"></span><span class="initial-hide">@{{player.name}} <span class="pull-right" style="font-size: 95%;">@{{player.tee_1}}<span v-if="player.tee_2.length > 0"> / @{{player.tee_2}}</span></span></span></td>
