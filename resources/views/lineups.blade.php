          ...
          <table class="players">
            ...
            <tbody>
              <tr v-for="player in players">
                <td class="fgi-player-name" style="width: 55%;"><span class="initial-hide">@{{player.name}} <span class="pull-right" style="font-size: 80%;">@{{player.tee_1}}<span v-if="player.tee_2.length > 0"> / @{{player.tee_2}}</span><span v-if="player.tee_3.length > 0"> / @{{player.tee_3}}</span></span></span></td>
